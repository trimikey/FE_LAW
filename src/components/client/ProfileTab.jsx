...
import { HiUser, HiPhone, HiMail, HiCloudUpload, HiCheckCircle, HiLockClosed } from "react-icons/hi";
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 px-4">
                <div>
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.4em] text-amber-500">Personal Account</span>
                    </div>
                    <h1 className="text-5xl font-black text-[#041837] tracking-tight uppercase">Hồ sơ cá nhân</h1>
                </div>
                <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <div className="lg:col-span-1 space-y-10">
                    <div className="bg-white rounded-[40px] border border-slate-100 p-10 shadow-sm text-center">
                        ...
                        <h3 className="text-2xl font-black text-[#041837] uppercase tracking-tight mb-2">{form.fullName || 'Thành viên'}</h3>
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-6">{form.email}</p>
                        <div className="flex justify-center gap-2">
                            <span className="px-3 py-1 bg-emerald-50 text-[9px] font-black text-emerald-600 rounded-lg uppercase tracking-widest border border-emerald-100 flex items-center gap-1">
                    ...
                    <div className="bg-white rounded-[40px] border border-slate-100 p-10 shadow-sm relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            <h3 className="text-lg font-black text-[#041837] uppercase tracking-tight mb-4">Bảo mật tài khoản</h3>
                            <p className="text-xs text-slate-400 font-medium leading-relaxed mb-6">Thay đổi mật khẩu định kỳ để đảm bảo an toàn cho tài khoản và dữ liệu cá nhân của bạn.</p>
                            <ChangePasswordCard />
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-2">
                    <div className="bg-white rounded-[40px] border border-slate-100 p-12 shadow-sm relative overflow-hidden h-full">
                        <div className="absolute top-0 right-0 p-12 opacity-[0.02]">
                            <HiUser className="h-64 w-64 text-[#041837]" />
                        </div>

                        <div className="relative z-10">
                            <h2 className="text-3xl font-black text-[#041837] uppercase tracking-tight mb-10">Thông tin liên hệ</h2>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                ...
                                <div className="space-y-3">
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2">Địa chỉ Email (Không thể thay đổi)</label>
                                    <div className="relative">
                                        <input
                                            type="email"
                                            value={form.email}
                                ...
                                <div className="pt-8">
                                    <div className="p-6 rounded-3xl bg-amber-50 border border-amber-100">
                                        ...
                                        <p className="text-xs text-amber-700/80 font-medium leading-relaxed italic">
                                            Thông tin cá nhân của bạn sẽ được bảo mật tuyệt đối và chỉ cung cấp cho luật sư khi có yêu cầu tư vấn chính thức. Hãy đảm bảo số điện thoại chính xác để luật sư có thể liên hệ.
                                        </p>
                                    </div>
                                </div>
                            </form>
