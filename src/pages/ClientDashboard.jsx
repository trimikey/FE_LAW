        ...
        <>
          ...
          {dashboard.activeTab === 'overview' && (
            <div className="relative mb-10 overflow-hidden rounded-[40px] bg-[#041837] text-white shadow-2xl animate-in fade-in slide-in-from-top-4 duration-700">
              ...
              <div className="relative z-10 flex flex-col items-center justify-between gap-8 px-10 py-12 md:flex-row">
                <div className="max-w-2xl text-center md:text-left">
                  <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-blue-500/20 px-4 py-1.5 backdrop-blur-md">
                    ...
                    <span className="text-xs font-bold uppercase tracking-widest text-blue-300">Trung tâm hỗ trợ pháp lý</span>
                  </div>
                  <h2 className="text-3xl font-extrabold tracking-tight md:text-5xl break-all md:break-normal">
                    Xin chào, <span className="text-amber-500">{user?.full_name}!</span>
                  </h2>
                  ...
                  <div className="mt-8 flex flex-wrap gap-4 justify-center md:justify-start">
                    <button onClick={() => dashboard.setShowCreateCase(true)} className="group flex items-center gap-2 rounded-2xl bg-amber-500 px-8 py-4 text-sm font-black uppercase tracking-widest text-[#041837] shadow-xl transition hover:bg-white active:scale-95">
                      <HiPlus className="h-5 w-5" />
                      Gửi yêu cầu pháp lý
                    </button>
                    <button onClick={() => navigate('/lawyer')} className="flex items-center gap-2 rounded-2xl border border-white/20 bg-white/5 px-8 py-4 text-sm font-bold uppercase tracking-widest text-white backdrop-blur-md transition hover:bg-white/10 active:scale-95">
          ...
          {dashboard.activeTab !== 'overview' && dashboard.activeTab !== 'messages' && dashboard.activeTab !== 'profile' && (
            <div className="relative mb-10 overflow-hidden rounded-[40px] bg-gradient-to-br from-[#041837] to-[#072558] text-white p-10 shadow-2xl animate-in fade-in slide-in-from-top-4 duration-700">
              ...
              <div className="relative z-10 flex flex-col gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-[0.4em] text-amber-500">Dành cho khách hàng</span>
                </div>
                <div>
                  ...
                  <p className="text-blue-100/60 font-medium text-sm mt-2">Chào mừng {user?.full_name}, hệ thống đã chuẩn bị đầy đủ dữ liệu cho bạn.</p>
                </div>
              </div>
            </div>
          )}
